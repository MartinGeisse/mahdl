...
public final class Expression_BinaryXorImpl extends ExpressionImpl implements Expression_BinaryXor {

	private final Expression leftOperand;
	private final Expression rightOperand;

	public Expression_BinaryXorImpl(int row, int column, Object[] childNodes) {
		super(row, column);
