...
public final class ModuleInstanceDefinitionImpl extends ASTWrapperPsiElement implements ModuleInstanceDefinition, PsiCm, PsiNameIdentifierOwner {

	public ModuleInstanceDefinitionImpl(@NotNull ASTNode node) {
		super(node);
	}
