...
public final class Expression_BinaryShiftLeftImpl extends ExpressionImpl implements Expression_BinaryShiftLeft,PsiCm,BinaryOperation {

    public Expression_BinaryShiftLeftImpl(@NotNull ASTNode node) {
        super(node);
    }
