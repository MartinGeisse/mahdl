...
public final class Expression_BinaryLessThanImpl extends ExpressionImpl implements Expression_BinaryLessThan, PsiCm {

	public Expression_BinaryLessThanImpl(@NotNull ASTNode node) {
		super(node);
	}
