...
public final class Expression_BinaryShiftRightImpl extends ExpressionImpl implements Expression_BinaryShiftRight,PsiCm,BinaryOperation {

    public Expression_BinaryShiftRightImpl(@NotNull ASTNode node) {
        super(node);
    }
