...
public final class Expression_BinaryGreaterThanImpl extends ExpressionImpl implements Expression_BinaryGreaterThan,PsiCm,BinaryOperation {

    public Expression_BinaryGreaterThanImpl(@NotNull ASTNode node) {
        super(node);
    }
