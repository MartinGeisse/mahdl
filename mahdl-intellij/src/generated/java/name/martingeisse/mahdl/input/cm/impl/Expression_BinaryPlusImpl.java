...
public final class Expression_BinaryPlusImpl extends ExpressionImpl implements Expression_BinaryPlus,PsiCm,BinaryOperation {

    public Expression_BinaryPlusImpl(@NotNull ASTNode node) {
        super(node);
    }
