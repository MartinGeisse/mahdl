...
public final class Expression_BinaryOrImpl extends ExpressionImpl implements Expression_BinaryOr,PsiCm,BinaryOperation {

    public Expression_BinaryOrImpl(@NotNull ASTNode node) {
        super(node);
    }
