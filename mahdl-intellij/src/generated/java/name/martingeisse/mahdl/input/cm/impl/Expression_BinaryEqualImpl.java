...
public final class Expression_BinaryEqualImpl extends ExpressionImpl implements Expression_BinaryEqual,PsiCm,BinaryOperation {

    public Expression_BinaryEqualImpl(@NotNull ASTNode node) {
        super(node);
    }
