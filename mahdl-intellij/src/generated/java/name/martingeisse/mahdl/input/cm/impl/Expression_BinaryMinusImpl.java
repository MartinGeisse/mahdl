...
public final class Expression_BinaryMinusImpl extends ExpressionImpl implements Expression_BinaryMinus, PsiCm {

	public Expression_BinaryMinusImpl(@NotNull ASTNode node) {
		super(node);
	}
